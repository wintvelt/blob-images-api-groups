...
export const main = handler(async (event, context) => {
    ...
    const { name, photoId, photoFilename, sortDate } = data;
    ...
    if (!(name || data.hasOwnProperty('photoId') || photoFilename || sortDate)) throw new Error('relevant album update details missing');
    ...
    if (sortDate) albumUpdate.sortDate = sortDate;
